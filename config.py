...
def load_core_config() -> CoreConfig:
    ...
    host = os.getenv("AGENT_ASSISTANT_HOST") or "127.0.0.1"
    port = int(os.getenv("AGENT_ASSISTANT_PORT") or "7438")
...
def load_llm_config() -> LlmConfig:
    ...
    api_key = (
        ...
        or os.getenv("AGENT_ASSISTANT_DEEPSEEK_API_KEY")
        or os.getenv("OPENAI_API_KEY")
    )
    if not api_key:
        raise RuntimeError(
            "Missing ANTHROPIC_API_KEY, DEEPSEEK_API_KEY, or "
            "AGENT_ASSISTANT_DEEPSEEK_API_KEY in .env"
        )
    ...
    if api_mode == "anthropic":
        ...
        base_url = (
            ...
            or os.getenv("AGENT_ASSISTANT_LLM_BASE_URL")
    ...
    if api_mode == "anthropic":
        model = (
            ...
            or os.getenv("AGENT_ASSISTANT_LLM_MODEL")
